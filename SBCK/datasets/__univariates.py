...
from ..stats.__rv_extend import rv_mixture
...
def gaussian_exp_mixture_1d( n_samples: int ) -> tuple[_Array,_Array,_Array]:##{{{
...
def gaussian_VS_exp_1d( n_samples: int ) -> tuple[_Array,_Array,_Array]:##{{{
    """Build a test dataset such that:
