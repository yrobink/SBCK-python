...
#class BCISkipNotValid(PrePostProcessing):
#	
#	"""
...
#		if self._isgood:
#			if X1 is not None:
#				PrePostProcessing.fit( self , Y0 , X0 , X1 )
#			else:
#				PrePostProcessing.fit( self , Y0 , X0 )
#	##}}}
#	
...
#		if self._isgood:
#			if X0 is not None:
#				Z = PrePostProcessing.predict( self , X1 , X0 )
#			else:
#				Z = PrePostProcessing.predict( self , X1 )
#		else:
